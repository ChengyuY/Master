...
import antlr4.ILPMLgrammar4exam1920Parser.ForContext;
...
public class ILPMLListener implements ILPMLgrammar4exam1920Listener {
	...
	@Override public void enterFor(ForContext ctx) {}

	@Override
	public void exitFor(ForContext ctx) {
		ctx.node = factory.newForeach(factory.newVariable(ctx.var.getText()),  ctx.iterator.node,  ctx.body.node);	
	}
